...
extern const BYTE
    MITIGATION_OPTIONS_VALUE_MICROSOFT_SIGNED_ONLY[MITIGATION_OPTIONS_DATA_SIZE];
extern const BYTE MITIGATION_OPTIONS_VALUE_DEFAULT[MITIGATION_OPTIONS_DATA_SIZE];
